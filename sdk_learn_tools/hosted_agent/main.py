...
class AgentConfig:
    ...
    max_turns: int = field(default_factory=lambda: int(os.getenv("AGENT_MAX_TURNS") or "10"))
    chat_history_length: int = field(default_factory=lambda: int(os.getenv("AGENT_CHAT_HISTORY_LENGTH") or "20"))
